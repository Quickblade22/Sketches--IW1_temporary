...
apptainer exec \
    ...
    mycontainer2.sif \
      sh -c "cd src && make clean  && echo 32 128 50000 time 10 000 000 sim lookahead_depth 1000 --max-depth 30000 --nodes-threshold 500000 --max-rep 120 >> output3.txt && python3 running.py /work/rleap1/aaditya_mehta/Sketches--IW1_temporary/Adventure.bin 50000 10000000 --additional-args='--lookahead_depth 1000 --max-depth 30000 --nodes-threshold 500000 --max-rep 120' --compile-first --output-file=output3.txt"
